...
- (id)init
{
    if (self = [super init])
    {
        ...
        self.frequencies        = [NSArray arrayWithObjects:@500, @1000, @2000, @4000, @8000, nil];
        self.labels             = [NSArray arrayWithObjects:@"500 Hz", @"1 kHz", @"2 kHz", @"4 kHz", @"8 kHz", nil];
       // self.wasGuessedWrong    = [NSArray arrayWithObjects:NO, NO, NO, NO, NO, nil];
